package AmazonPolly.AmazonPollyTest;
...
public class PolyDemo {
	...
	public PolyDemo(Region region) {
	    ...
	    // System.out.println(i + ":" + voice.getLanguageName());
		// }
	...
	public static void main(String args[]) throws Exception {
		...
		PolyDemo helloWorld = new PolyDemo(Region.getRegion(Regions.US_EAST_1));
